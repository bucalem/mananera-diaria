...
from nombres import (clave_merge, categoria_funcionario, normaliza_hablante,
                     _segmento_nombre, _tiene_cargo, _sin_acentos,
                     PARTICULAS, HONORIFICOS)
...
def build_speakers(turns: list[dict]) -> dict:
    ...
    nombres = sorted(seleccion, key=lambda n: (-func_counter[n], n))
    top_funcionarios = [
